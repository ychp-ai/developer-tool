        ...
        >
          ...
          >
              ...
              <div className="mb-3 relative flex-shrink-0">
                ...
                <input
                  ...
                  aria-activedescendant={
                    selectedSearchIndex >= 0 && searchQuery.trim()
                      ? `nav-result-${selectedSearchIndex}`
                      : undefined
                  }
                  ref={searchInputRef}
                  type="text"
            ...
            <div
              ...
              role={searchQuery.trim() ? 'listbox' : undefined}
              aria-label="导航工具列表"
              className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 sidebar-scrollbar"
            >
                    ...
                    {!sidebarCollapsed ? (
                            ...
                            {group.tools.map((tool) => {
                              ...
                              return (
                                ...
                                >
                                  <MenuToolLink
                                    tool={tool}
                                    id={`nav-result-${globalIndex}`}
                                    role={
                                      searchQuery.trim() ? 'option' : undefined
                                    }
                                    selected={
                                      searchQuery.trim()
                                        ? Boolean(isSelected)
                                  ...
                                  <button
                                    ...
                                    aria-label={`${favorites.has(tool.path) ? '取消收藏' : '收藏'} ${tool.name}`}
                                    title={
                                      favorites.has(tool.path)
                                        ? '取消收藏'
                                        : '收藏'
                      ...
                      >
                        <button
                          ...
                          aria-expanded={hoveredGroup === group.name}
                          onClick={() => {
                            ...
                            requestAnimationFrame(() =>
                              document
                                .getElementById(`nav-group-${group.name}`)
                                ?.focus(),
                            );
                          }}
                          onMouseEnter={(e) => {
